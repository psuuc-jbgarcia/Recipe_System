...
<body>
    <div class="container">
        <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
            <div class="col-md-3 mb-2 mb-md-0">
                <div>
                <a class="navbar-brand d-inline-flex link-body-emphasis text-decoration-none" href="../user_dashboard/userdashboard.php?filter=rating"><i class="bi bi-arrow-left">Back</i></a>
                </div>
            </div>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function updateURL() {
            ...
            if (filterIndex === -1) {
                var newURL = currentURL + '?filter=rating';
        ...
        // Update URL when clicking the back button
  ...
  <!-- JavaScript for preserving filter=rating in URL -->
